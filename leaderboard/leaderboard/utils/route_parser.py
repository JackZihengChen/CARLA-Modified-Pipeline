...
class RouteParser(object):
    ...
    @staticmethod
    def parse_routes_file(route_filename, scenario_file, single_route=None, weather_overwrite=None):
        """
        ...
        for route in tree.iter("route"):
            ...
            # parse weather
            if not weather_overwrite:
                new_config.weather = RouteParser.parse_weather(route)
            elif type(weather_overwrite) == carla.WeatherParameters:
                new_config.weather = weather_overwrite
            else:
                raise ValueError("weather overwrite must be of type carla.WeatherParameters")
