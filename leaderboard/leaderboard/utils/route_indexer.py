...
class RouteIndexer():
    def __init__(self, routes_file, scenarios_file, repetitions, weather_overwrite=None):
        ...
        # retrieve routes
        route_configurations = RouteParser.parse_routes_file(self._routes_file, self._scenarios_file, False, weather_overwrite)
