...
class GhostCutIn(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        # raise Exception
        # # New 
        # front_left_wheel  = carla.WheelPhysicsControl(tire_friction=0.0, damping_rate=1.5, max_steer_angle=70.0, long_stiff_value=1000)
        # front_right_wheel = carla.WheelPhysicsControl(tire_friction=0.0, damping_rate=1.5, max_steer_angle=70.0, long_stiff_value=1000)
        # rear_left_wheel   = carla.WheelPhysicsControl(tire_friction=0.0, damping_rate=1.5, max_steer_angle=0.0,  long_stiff_value=1000)
        # rear_right_wheel  = carla.WheelPhysicsControl(tire_friction=0.0, damping_rate=1.5, max_steer_angle=0.0,  long_stiff_value=1000)
    ...
    def _create_behavior(self):
        ...
        # Original distance: 4.3, new distance: 3.7
        ...
        # with open('testies.html', 'w') as f:
        #     try:
        #         f.write('<html><head><title>Foo</title><body>')
        #         # f.write(py_trees.display.render_dot_tree(sequence, visibility_level=py_trees.common.VisibilityLevel.DETAIL))
        #         py_trees.display.render_dot_tree(sequence, visibility_level=py_trees.common.VisibilityLevel.DETAIL)
        #         f.write("</body></html>")
